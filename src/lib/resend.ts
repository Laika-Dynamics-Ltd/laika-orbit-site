    ...
    const r = await call('/emails', {
      ...
      body: JSON.stringify({
        ...
        text: [
          ...
          '',
          "Pro's headline is Orbit Anywhere: the iPhone app, approvals from anywhere, push alerts,",
          'the morning briefing on your phone, and sync. It is being built; sync is aiming for the',
          'first half of 2027. Today Pro is the signed Mac app with automatic updates and priority',
          'support, a named reply within one NZ working day.',
          '',
          'Founding members lock in US$15 a month or US$150 a year for as long as they stay',
          'subscribed. The standard price becomes US$20 a month once Anywhere ships.',
          '',
